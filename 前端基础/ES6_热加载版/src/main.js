...
// aa.__proto__ = person 
// console.log(aa.kind)
// console.log(person.isPrototypeOf(aa))

// var person = {kind: 'aline'}
// console.log(person)
// var cc = Object.create(person,{name: {value: 'wangdonghai',writable: true,configurable: false, numerable: false}})
// console.log(cc.kind)
...
// console.log(F.prototype === f.__proto__) // 函数的原型===实例的原型 
...
// console.log(Person.propertyIsEnumerable('title'))
...
// let obj = {}
// let address = {'province': 'shenzhen', 'city': 'longgang'}
...
// address = {'position': 'shenzhen guangzhou'}
